...
export interface TransactionCategory {
  ...
  categoryId: string;
  categoryName: string;
  isManual: boolean; // true if manually assigned by user, false if auto-categorized
  isMain: boolean; // true if this is the main category for the transaction (used for analytics)
  createdAt: Date;
}
